    ...
    return when (topChromePolicy.tabPresentation) {
        AppTopTabPresentation.TONAL_CAPSULE -> {
            CommonListFavoriteHeaderLayout(
                ...
                browseToggleHeightDp = AppChromeSizeTokens.InContentLiquidSegmentedControlHeightDp,
                browseToggleIndicatorHeightDp = AppChromeSizeTokens.InContentLiquidSegmentedIndicatorHeightDp,
